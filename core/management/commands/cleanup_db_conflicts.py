...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with connection.cursor() as cursor:
            ...
            self.stdout.write('Dropando índice core_storeauditissue_status_f5972555...')
            ...
            cursor.execute("DROP INDEX IF EXISTS core_analystassignment_active_7f972555 CASCADE;") # Nome aproximado
